            ...
            <div class="flex justify-between h-16 items-center">
                <div class="flex items-center gap-8">
                    ...
                    <a href="/" wire:navigate class="flex items-center gap-3 group">
                        <span class="flex items-center justify-center w-9 h-9 bg-emerald-800/60 rounded-xl text-xl group-hover:bg-emerald-700/60 transition-colors duration-300">🌍</span>
                        <span class="text-lg font-bold text-white tracking-tight">
                            IUCN <span class="text-emerald-400 group-hover:text-emerald-300 transition-colors duration-300">Explorer</span>
                        </span>
                    </a>
                ...
                <div class="flex sm:hidden items-center gap-1">
                    <a
                        ...
                        class="inline-flex items-center justify-center w-10 h-10 rounded-xl transition-all duration-300
                            {{ request()->is('/') ? 'text-white bg-emerald-800/60' : 'text-emerald-400/70 hover:text-white hover:bg-emerald-800/40' }}"
                        title="Dashboard"
                    >
